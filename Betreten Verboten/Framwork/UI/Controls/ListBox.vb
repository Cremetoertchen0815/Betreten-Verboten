    ...
    Public Class ListBox
        ...
        Public Overrides Sub Draw(gameTime As GameTime)
            ...
            For i As Integer = 0 To workingtext.Length - 1
                ...
                If rc.Top >= rect.Top And rc.Bottom <= rect.Bottom Then SpriteBatch.DrawString(Font, workingtext(i), lv, Color)
                If i = SelectedIndex And EnableSelect Then Graphics.DrawRectangle(New Rectangle(rect.Location + New Point(0, i * 30 + offsetY), New Point(Size.X, 30)), Color.CornflowerBlue, 2)
            Next

            SpriteBatch.Draw(ArrowA, New Rectangle(New Point(rect.Right - 25, rect.Top + 10) + New Point(ArrowA.Height / 2), New Point(25)), Nothing, Color.White, Math.PI / 2, New Vector2(ArrowA.Height / 2), SpriteEffects.None, 0)
            SpriteBatch.Draw(ArrowB, New Rectangle(New Point(rect.Right - 25, rect.Bottom - 25) + New Point(ArrowA.Height / 2), New Point(25)), Nothing, Color.White, Math.PI / 2, New Vector2(ArrowA.Height / 2), SpriteEffects.None, 0)
        End Sub
        ...
        Public Overrides Sub Update(gameTime As GameTime, mstate As GuiInput, offset As Vector2)
            ...
            If New Rectangle(rect.Right - 25, rect.Top + 10, 25, 25).Contains(mstate.MousePosition) And (mstate.LeftClickOneshot Or mstate.LeftClickFullBlast) Then
                offsetY += gameTime.ElapsedGameTime.TotalMilliseconds / 3
