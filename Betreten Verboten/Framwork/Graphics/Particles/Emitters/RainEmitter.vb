...
Namespace Framework.Graphics.Effects.Particles.Emmiters
    ...
    Public Class RainEmitter
        ...
        Public Sub New(particle As Particle, spawnHeight As Integer, Optional speeddiv As Integer = 65)
            ...
            txt = {Content.Load(Of Texture2D)("fx\textures\particles\particle_rain_1"), Content.Load(Of Texture2D)("fx\textures\particles\particle_rain_2"), Content.Load(Of Texture2D)("fx\textures\particles\particle_rain_3")}
        End Sub
