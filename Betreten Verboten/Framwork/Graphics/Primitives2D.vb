...
Namespace Framework.Graphics
    ...
    Module Primitives2D
        ...
        Public cPrimitiveSidesPerRadius As Integer = 7
        ...
        Sub FillRectangle(ByVal rect As Rectangle, ByVal color As Color)
            ...
            SpriteBatch.Draw(ReferencePixel, rect, color)
        End Sub

        <Extension()>
        Sub FillRectangle(ByVal rect As Rectangle, ByVal color As Color, ByVal angle As Single)

            SpriteBatch.Draw(ReferencePixel, rect, Nothing, color, angle, Vector2.Zero, SpriteEffects.None, 0)
        End Sub
        ...
        Sub FillRectangle(ByVal location As Vector2, ByVal size As Vector2, ByVal color As Color, ByVal angle As Single)
            ...
            SpriteBatch.Draw(ReferencePixel, location, Nothing, color, angle, Vector2.Zero, size, SpriteEffects.None, 0)
        End Sub
        ...
        <Extension()>
        Sub DrawRectangleCentered(ByVal rect As Rectangle, ByVal color As Color)
            DrawRectangleCentered(rect, color, 1.0F)
        End Sub

        <Extension()>
        Sub DrawRectangleCentered(ByVal rect As Rectangle, ByVal color As Color, ByVal thickness As Single)
            DrawLineCentered(New Vector2(rect.X, rect.Y), New Vector2(rect.Right, rect.Y), color, thickness)
            DrawLineCentered(New Vector2(rect.X + 1.0F, rect.Y), New Vector2(rect.X + 1.0F, rect.Bottom), color, thickness)
            DrawLineCentered(New Vector2(rect.X, rect.Bottom), New Vector2(rect.Right, rect.Bottom), color, thickness)
            DrawLineCentered(New Vector2(rect.Right + 1.0F, rect.Y), New Vector2(rect.Right + 1.0F, rect.Bottom), color, thickness)
        End Sub
        ...
        Sub DrawLine(ByVal point As Vector2, ByVal length As Single, ByVal angle As Single, ByVal color As Color, ByVal thickness As Single)
            SpriteBatch.Draw(ReferencePixel, point, Nothing, color, angle, Vector2.Zero, New Vector2(length, thickness), SpriteEffects.None, 0)
        End Sub
        Sub DrawLineCentered(ByVal point1 As Vector2, ByVal point2 As Vector2, ByVal color As Color, ByVal thickness As Single)
            Dim distance As Single = Vector2.Distance(point1, point2)
            Dim angle As Single = CSng(Math.Atan2(point2.Y - point1.Y, point2.X - point1.X))
            DrawLineCentered(point1, distance, angle, color, thickness)
        End Sub
        Sub DrawLineCentered(ByVal point As Vector2, ByVal length As Single, ByVal angle As Single, ByVal color As Color, ByVal thickness As Single)
            SpriteBatch.Draw(ReferencePixel, point, Nothing, color, angle, Vector2.UnitY * 0.5, New Vector2(length, thickness), SpriteEffects.None, 0)
        End Sub
        ...
        Sub PutPixel(ByVal position As Vector2, ByVal color As Color)
            SpriteBatch.Draw(ReferencePixel, position, color)
        End Sub
